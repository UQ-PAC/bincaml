  ...
  [
     ...
     block %main_entry [
       var #4_1:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤) := bvadd(R31_in,
     ...
     block %main_5 (
       ...
       var R29_5:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤) := phi(%main_25 -> #4_1:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤),
          %main_7 -> R29_4:bv64),
       var R31_5:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤) := phi(%main_25 -> #4_1:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤),
          %main_7 -> R31_4:bv64),
     ...
     block %main_19 (
       ...
       var R29_3:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤) := phi(%main_3 -> R29_6:bv64,
          %main_21 -> #4_1:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤)),
       var R31_3:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤) := phi(%main_3 -> R31_6:bv64,
          %main_21 -> #4_1:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤)),
  ...
  proc @puts_1584(CF_in:bv1, NF_in:bv1, R0_in:bv64, R1_in:bv64,
     R29_in:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤), R30_in:bv64,
     R31_in:ptr(rec124838810 of {"field-32": (bv64, -32)} 64, ⊤), VF_in:bv1,
     ZF_in:bv1)
     -> (CF_out:bv1, NF_out:bv1, R0_out:bv64, R1_out:bv64, R29_out:bv64,
