  ...
  bincaml: [ERROR] non-equal variables with same name: { Var.V.name = "R0_6"; typ = bv64; scope = Var.LocalVar } { Var.V.name = "R0_6"; typ = rec653825801; scope = Var.LocalVar }
  (run-transforms type-check)
  bincaml: [ERROR] non-equal variables with same name: { Var.V.name = "R0_6"; typ = bv64; scope = Var.LocalVar } { Var.V.name = "R0_6"; typ = rec653825801; scope = Var.LocalVar }
  ...
  [
     block %main_entry [
       ...
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) bvsub(R31_in:bv64, 0x4:bv64) (R0_in:rec219118263.field0) 32;
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) bvsub(R31_in:bv64,
       ...
       bvconcat(0x0:bv31, (R0_6:rec653825801.field0)));
       var #5_1:bv32 := bvadd((R0_7:rec219118263.field0), 0xffffffff:bv32);
       var VF_2:bv1 := bvnot(booltobv1(eq(sign_extend(1, bvadd(#5_1:bv32, 0x1:bv32)),
          sign_extend(1, (R0_7:rec219118263.field0)))));
       var CF_2:bv1 := bvnot(booltobv1(eq(zero_extend(1, bvadd(#5_1:bv32, 0x1:bv32)),
          bvadd(zero_extend(1, (R0_7:rec219118263.field0)), 0x100000000:bv33))));
     ...
     block %main_3 [
       ...
       bvadd((R0_19:rec219118263.field0), 0x1:bv32));
       $mem:(bv64->bv8) := store le $mem:(bv64->bv8) 0x2003c:bv64 (R1_6:rec219118263.field0) 32;
       goto (%main_19);
     ];
     block %main_19 (
       ...
       (var CF_4:bv1=CF_out, var NF_4:bv1=NF_out, var R0_10:bv64=R0_out,
          ...
          NF_in=NF_3:bv1, R0_in=0x820:bv64, R1_in=R1_2:rec219118263,
     ...
     block %main_17 [
       ...
       var #6_1:bv32 := bvadd((R0_13:rec219118263.field0), 0xfffffffa:bv32);
       var VF_5:bv1 := bvnot(booltobv1(eq(sign_extend(1, bvadd(#6_1:bv32, 0x1:bv32)),
          bvadd(sign_extend(1, (R0_13:rec219118263.field0)), 0x1fffffffb:bv33))));
       var CF_5:bv1 := bvnot(booltobv1(eq(zero_extend(1, bvadd(#6_1:bv32, 0x1:bv32)),
          bvadd(zero_extend(1, (R0_13:rec219118263.field0)), 0xfffffffb:bv33))));
