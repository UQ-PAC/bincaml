  ...
  [
     ...
     block %main_entry [
       var #4_1:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤) := bvadd(R31_in:bv64,
        0xffffffffffffffe0:bv64);
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) #4_1:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤) R29_in:bv64 64;
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) ptradd(#4_1:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤),
     ...
     block %main_5 (
       ...
       var R29_5:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤) := phi(%main_25 -> #4_1:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤),
          %main_7 -> R29_4:bv64),
       var R31_5:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤) := phi(%main_25 -> #4_1:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤),
          %main_7 -> R31_4:bv64),
       ...
       (var CF_7:bv1=CF_out, var NF_7:bv1=NF_out, var R0_16:bv64=R0_out,
          ...
          R29_in=R29_5:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤),
          R30_in=0x7a0:bv64,
          R31_in=R31_5:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤),
     ...
     block %main_19 (
       ...
       var R29_3:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤) := phi(%main_3 -> R29_6:bv64,
          %main_21 -> #4_1:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤)),
       var R31_3:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤) := phi(%main_3 -> R31_6:bv64,
          %main_21 -> #4_1:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤)),
       ...
       (var CF_4:bv1=CF_out, var NF_4:bv1=NF_out, var R0_10:bv64=R0_out,
          ...
          R29_in=R29_3:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤),
          R30_in=0x7d0:bv64,
          R31_in=R31_3:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤),
     ...
     block %main_15 [
       ...
       (var CF_8:bv1=CF_out, var NF_8:bv1=NF_out, var R0_24:bv64=R0_out,
          ...
          var R31_7:ptr(rec944453953 of {"field0": (bv64, 0)} 64, rec944453953 of {"field0": (bv64, 0)} 64)=R31_out,
     ...
     block %main_11 [
       var load21_1:bv64 := load le $stack:(bv64->bv8) R31_7:ptr(rec944453953 of {"field0": (bv64, 0)} 64, rec944453953 of {"field0": (bv64, 0)} 64) 64;
       var load22_1:bv64 := load le $stack:(bv64->bv8) ptradd(R31_7:ptr(rec944453953 of {"field0": (bv64, 0)} 64, rec944453953 of {"field0": (bv64, 0)} 64),
        0x8:bv64) 64;
       var R31_8:bv64 := ptradd(R31_7:ptr(rec944453953 of {"field0": (bv64, 0)} 64, rec944453953 of {"field0": (bv64, 0)} 64),
        0x20:bv64);
  ...
  proc @puts_1584(CF_in:bv1, NF_in:bv1, R0_in:bv64, R1_in:bv64,
     R29_in:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤), R30_in:bv64,
     R31_in:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤), VF_in:bv1,
     ZF_in:bv1)
     -> (CF_out:bv1, NF_out:bv1, R0_out:bv64, R1_out:bv64, R29_out:bv64,
