  ...
  [
     ...
     block %main_entry [
       var #4_1:ptr(rec151711918 of {"field-32": (bv64, -32)} 64, ⊤) := bvadd(R31_in,
        0xffffffffffffffe0:bv64);
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) #4_1 R29_in 64;
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) ptradd(#4_1, 0x8:bv64) R30_in 64;
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) ptradd(#4_1, 0x1c:bv64) extract(32,0, R0_in) 32;
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) ptradd(#4_1, 0x10:bv64) R1_in 64;
     ...
     block %main_5 (
       ...
       (var CF_7:bv1=CF_out, var NF_7:bv1=NF_out, var R0_16:bv64=R0_out,
          ...
          NF_in=NF_6, R0_in=0x820:bv64, R1_in=R1_4, R29_in=R29_5, R30_in=0x7a0:bv64,
     ...
     block %main_19 (
       ...
       (var CF_4:bv1=CF_out, var NF_4:bv1=NF_out, var R0_10:bv64=R0_out,
          ...
          NF_in=NF_3, R0_in=0x820:bv64, R1_in=R1_2, R29_in=R29_3, R30_in=0x7d0:bv64,
     ...
     block %main_15 [
       ...
       (var CF_8:bv1=CF_out, var NF_8:bv1=NF_out, var R0_24:bv64=R0_out,
          ...
          var VF_8:bv1=VF_out, var ZF_12:bv1=ZF_out) := call @puts_1584(CF_in=CF_5,
          NF_in=NF_5, R0_in=0x828:bv64, R1_in=R1_3, R29_in=R29_4, R30_in=0x7f4:bv64,
          R31_in=R31_4, VF_in=VF_5, ZF_in=ZF_7);
       goto (%main_13);
     ];
     block %main_13 [ goto (%main_11); ];
     block %main_11 [
       var load21_1:bv64 := load le $stack:(bv64->bv8) R31_7 64;
       var load22_1:bv64 := load le $stack:(bv64->bv8) ptradd(R31_7, 0x8:bv64) 64;
       var R31_8:bv64 := ptradd(R31_7, 0x20:bv64);
