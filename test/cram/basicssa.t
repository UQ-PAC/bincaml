...
Run on basic irreducible loop example
  ...
  [
     block %main_entry [
       ...
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) #4:bv64 $R29 64;
       $stack:(bv64->bv8) := store le $stack:(bv64->bv8) bvadd(#4:bv64, 0x8:bv64) $R30 64;
       $R31:bv64 := #4:bv64;
       $R29:bv64 := $R31;
  ...
  [
     ...
     block %main_entry [
       var #4_1:bv64 := bvsub(R31_1:bv64, 0x20:bv64);
