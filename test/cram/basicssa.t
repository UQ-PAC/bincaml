...
Run on basic irreducible loop example
  ...
  [
     block %inputs [
        (var CF:bv1 := CF_in, var NF:bv1 := NF_in, var R0:bv64 := R0_in,
         var R1:bv64 := R1_in, var R29:bv64 := R29_in, var R30:bv64 := R30_in,
         var R31:bv64 := R31_in, var VF:bv1 := VF_in, var ZF:bv1 := ZF_in);
        goto (%main_entry);
     ];
     block %main_entry [
        var #4_1:bv64 := bvadd(R31, 0xffffffffffffffe0:bv64);
        $stack:(bv64->bv8) := store le $stack:(bv64->bv8) #4_1 R29 64;
        $stack:(bv64->bv8) := store le $stack:(bv64->bv8) bvadd(#4_1, 0x8:bv64) R30 64;
        var R31_1:bv64 := #4_1;
        var R29_1:bv64 := R31_1;
        $stack:(bv64->bv8) := store le $stack:(bv64->bv8) bvadd(R31_1, 0x1c:bv64) extract(32,0, R0) 32;
        $stack:(bv64->bv8) := store le $stack:(bv64->bv8) bvadd(R31_1, 0x10:bv64) R1 64;
        var R0_1:bv64 := 0x20000:bv64;
        var R0_2:bv64 := bvadd(R0_1, 0x3c:bv64);
        $mem:(bv64->bv8) := store le $mem:(bv64->bv8) R0_2 0x0:bv32 32;
        var R0_3:bv64 := 0x20000:bv64;
        var R0_4:bv64 := bvadd(R0_3, 0x40:bv64);
        var load18_1:bv32 := load le $mem:(bv64->bv8) R0_4 32;
        var R0_5:bv64 := zero_extend(32, load18_1);
        var R0_6:bv64 := zero_extend(32, bvconcat(0x0:bv31, extract(1,0, R0_5)));
        var #5_1:bv32 := bvadd(extract(32,0, R0_6), 0xffffffff:bv32);
        var VF_1:bv1 := bvnot(booltobv1(eq(sign_extend(1, bvadd(#5_1, 0x1:bv32)),
           sign_extend(1, extract(32,0, R0_6)))));
        var CF_1:bv1 := bvnot(booltobv1(eq(zero_extend(1, bvadd(#5_1, 0x1:bv32)),
           bvadd(zero_extend(1, extract(32,0, R0_6)), 0x100000000:bv33))));
        var ZF_1:bv1 := booltobv1(eq(bvadd(#5_1, 0x1:bv32), 0x0:bv32));
        var NF_1:bv1 := extract(32,31, bvadd(#5_1, 0x1:bv32));
        goto (%main_27,%main_23);
     ];
     block %main_23 [
        guard neq(booltobv1(eq(ZF_1, 0x1:bv1)), 0x0:bv1);
        goto (%main_21);
     ];
     block %main_21 [ goto (%main_19); ];
     block %main_27 [
        guard eq(booltobv1(eq(ZF_1, 0x1:bv1)), 0x0:bv1);
        goto (%main_25);
     ];
     block %main_25 [ goto (%main_5); ];
     block %main_5 [
        ...
        var R0_14:bv64 := bvadd(R0_13, 0x820:bv64);
        ...
        call @puts_1584(CF_in=CF_5, NF_in=NF_5, R0_in=R0_14, R1_in=R1_3,
           R29_in=R29_4, R30_in=R30_3, R31_in=R31_4, VF_in=VF_5, ZF_in=ZF_5);
        goto (%main_3);
     ];
     block %main_3 [
        var R0_16:bv64 := 0x20000:bv64;
        var R0_17:bv64 := bvadd(R0_16, 0x3c:bv64);
        var load19_1:bv32 := load le $mem:(bv64->bv8) R0_17 32;
        var R0_18:bv64 := zero_extend(32, load19_1);
        var R1_5:bv64 := zero_extend(32, bvadd(extract(32,0, R0_18), 0x1:bv32));
        var R0_19:bv64 := 0x20000:bv64;
        var R0_20:bv64 := bvadd(R0_19, 0x3c:bv64);
        $mem:(bv64->bv8) := store le $mem:(bv64->bv8) R0_20 extract(32,0, R1_5) 32;
        goto (%main_19);
     ];
     block %main_19 [
        ...
        var R0_8:bv64 := bvadd(R0_7, 0x820:bv64);
        ...
        call @puts_1584(CF_in=CF_2, NF_in=NF_2, R0_in=R0_8, R1_in=R1_1, R29_in=R29_2,
           R30_in=R30_1, R31_in=R31_2, VF_in=VF_2, ZF_in=ZF_2);
        goto (%main_17);
     ];
     block %main_17 [
        var R0_10:bv64 := 0x20000:bv64;
        var R0_11:bv64 := bvadd(R0_10, 0x3c:bv64);
        var load20_1:bv32 := load le $mem:(bv64->bv8) R0_11 32;
        var R0_12:bv64 := zero_extend(32, load20_1);
        var #6_1:bv32 := bvadd(extract(32,0, R0_12), 0xfffffffa:bv32);
        var VF_4:bv1 := bvnot(booltobv1(eq(sign_extend(1, bvadd(#6_1, 0x1:bv32)),
           bvadd(sign_extend(1, extract(32,0, R0_12)), 0x1fffffffb:bv33))));
        var CF_4:bv1 := bvnot(booltobv1(eq(zero_extend(1, bvadd(#6_1, 0x1:bv32)),
           bvadd(zero_extend(1, extract(32,0, R0_12)), 0xfffffffb:bv33))));
        var ZF_4:bv1 := booltobv1(eq(bvadd(#6_1, 0x1:bv32), 0x0:bv32));
        var NF_4:bv1 := extract(32,31, bvadd(#6_1, 0x1:bv32));
        goto (%main_15,%main_9);
     ];
     block %main_9 [
        guard neq(bvnot(booltobv1(eq(ZF_4, 0x1:bv1))), 0x0:bv1);
        goto (%main_7);
     ];
     block %main_7 [ goto (%main_5); ];
     block %main_15 [
        guard eq(bvnot(booltobv1(eq(ZF_4, 0x1:bv1))), 0x0:bv1);
        var R0_21:bv64 := 0x0:bv64;
        var R0_22:bv64 := bvadd(R0_21, 0x828:bv64);
        ...
        call @puts_1584(CF_in=CF_4, NF_in=NF_4, R0_in=R0_22, R1_in=R1_2,
           R29_in=R29_3, R30_in=R30_5, R31_in=R31_3, VF_in=VF_4, ZF_in=ZF_4);
        goto (%main_13);
     ];
     block %main_13 [ goto (%main_11); ];
     block %main_11 [
        var R0_24:bv64 := 0x0:bv64;
        var load21_1:bv64 := load le $stack:(bv64->bv8) R31_6 64;
        var R29_7:bv64 := load21_1;
        var load22_1:bv64 := load le $stack:(bv64->bv8) bvadd(R31_6, 0x8:bv64) 64;
        var R30_7:bv64 := load22_1;
        var R31_7:bv64 := bvadd(R31_6, 0x20:bv64);
        goto (%main_basil_return_1);
     ];
     block %main_basil_return_1 [ goto (%returns); ];
     block %returns [
        (var CF_out:bv1 := CF_7, var NF_out:bv1 := NF_7, var R0_out:bv64 := R0_24,
         var R1_out:bv64 := R1_6, var R29_out:bv64 := R29_7,
         var R30_out:bv64 := R30_7, var R31_out:bv64 := R31_7,
         var VF_out:bv1 := VF_7, var ZF_out:bv1 := ZF_7);
        return;
     ]
  ];
