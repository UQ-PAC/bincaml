...
[@@expect.uncaught_exn
  ...
  Called from Test_aslp__Test_aslp_ibi.(fun) in file "test/transforms/test_aslp_ibi.ml", line 43, characters 5-54
...
[@@expect.uncaught_exn
  ...
  Called from Test_aslp__Test_aslp_ibi.(fun) in file "test/transforms/test_aslp_ibi.ml", line 65, characters 2-46
  Called from Ppx_expect_runtime__Test_block.Configured.dump_backtrace in file "runtime/test_block.ml", line 142, characters 10-28
...
[@@expect.uncaught_exn
  ...
  Called from Transforms__Aslp__Diamond_ibi.Make.f_switch_context in file "lib/transforms/aslp/diamond_ibi.ml", line 63, characters 4-34
  Called from Transforms__Aslp__Bincaml_ibi_make.Make.f_switch_context in file "lib/transforms/aslp/bincaml_ibi_make.ml", line 71, characters 4-29
  Called from Test_aslp__Test_aslp_ibi.(fun) in file "test/transforms/test_aslp_ibi.ml", line 138, characters 2-44
  Called from Ppx_expect_runtime__Test_block.Configured.dump_backtrace in file "runtime/test_block.ml", line 142, characters 10-28
...
[@@expect.uncaught_exn
  ...
  Called from Transforms__Aslp__Diamond_ibi.Make.f_switch_context in file "lib/transforms/aslp/diamond_ibi.ml", line 63, characters 4-34
  Called from Transforms__Aslp__Bincaml_ibi_make.Make.f_switch_context in file "lib/transforms/aslp/bincaml_ibi_make.ml", line 71, characters 4-29
  Called from Test_aslp__Test_aslp_ibi.(fun) in file "test/transforms/test_aslp_ibi.ml", line 178, characters 2-44
  Called from Ppx_expect_runtime__Test_block.Configured.dump_backtrace in file "runtime/test_block.ml", line 142, characters 10-28
