...
and prtDecl (i:int) (e : AbsBasilIR.decl) : doc = match e with
  ...
  |    AbsBasilIR.Decl_Fun (globalident, localvarparens, attribset, type_, expr) -> prPrec i 0 (concatD [render "let" ; prtGlobalIdent 0 globalident ; prtLocalVarParenListBNFC 0 localvarparens ; prtAttribSet 0 attribset ; render ":" ; prtTypeT 0 type_ ; render "=" ; prtExpr 0 expr])
...
and prtFieldVal (i:int) (e : AbsBasilIR.fieldVal) : doc = match e with
       AbsBasilIR.FieldVal1 (openparen, str, bvval, type_, closeparen) -> prPrec i 0 (concatD [prtOpenParen 0 openparen ; prtStr 0 str ; render ":" ; prtBVVal 0 bvval ; render "," ; prtTypeT 0 type_ ; prtCloseParen 0 closeparen])
...
and prtExpr (i:int) (e : AbsBasilIR.expr) : doc = match e with
  ...
  |    AbsBasilIR.Expr_Let (localident, localvarparens, type_, expr1, expr2) -> prPrec i 0 (concatD [render "let" ; prtLocalIdent 0 localident ; prtLocalVarParenListBNFC 0 localvarparens ; render ":" ; prtTypeT 0 type_ ; render "=" ; prtExpr 0 expr1 ; render "in" ; prtExpr 0 expr2])
  ...
  |    AbsBasilIR.Expr_Assoc (intrinop, openparen, exprs, closeparen) -> prPrec i 2 (concatD [prtIntrinOp 0 intrinop ; prtOpenParen 0 openparen ; prtExprListBNFC 0 exprs ; prtCloseParen 0 closeparen])
  ...
  |    AbsBasilIR.Expr_Field (expr, localident) -> prPrec i 0 (concatD [prtExpr 2 expr ; render "&" ; prtLocalIdent 0 localident])
...
and prtBinOp (i:int) (e : AbsBasilIR.binOp) : doc = match e with
  ...
  |    AbsBasilIR.BinOp_get  -> prPrec i 0 (concatD [render "get"])
...
and prtIntrinOp (i:int) (e : AbsBasilIR.intrinOp) : doc = match e with
       AbsBasilIR.IntrinOp_booland  -> prPrec i 0 (concatD [render "booland"])
  |    AbsBasilIR.IntrinOp_boolor  -> prPrec i 0 (concatD [render "boolor"])
  |    AbsBasilIR.IntrinOp_bvand  -> prPrec i 0 (concatD [render "bvand"])
  |    AbsBasilIR.IntrinOp_bvor  -> prPrec i 0 (concatD [render "bvor"])
  |    AbsBasilIR.IntrinOp_bvadd  -> prPrec i 0 (concatD [render "bvadd"])
  |    AbsBasilIR.IntrinOp_bvxor  -> prPrec i 0 (concatD [render "bvxor"])
