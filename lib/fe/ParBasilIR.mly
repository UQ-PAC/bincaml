...
pointerType : pOINTERTYPE openParen typeT SYMB2 typeT closeParen { PointerType1 ($1, $2, $3, $5, $6) }
  ;
...
fieldVal_list : /* empty */ { []  }
  | fieldVal { (fun x -> [x]) $1 }
  | fieldVal KW_f fieldVal_list { (fun (x,xs) -> x::xs) ($1, $3) }
  ;
...
expr : expr1 {  $1 }
  ...
  | KW_facces openParen intVal SYMB2 expr closeParen { Expr_FAccess ($2, $3, $5, $6) }
  ;
