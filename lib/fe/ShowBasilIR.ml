...
and showField (e : AbsBasilIR.field) : showable = match e with
       AbsBasilIR.Field1 (openparen, intval0, intval, closeparen, type') -> s2s "Field1" >> c2s ' ' >> c2s '(' >> showOpenParen openparen  >> s2s ", " >>  showIntVal intval0  >> s2s ", " >>  showIntVal intval  >> s2s ", " >>  showCloseParen closeparen  >> s2s ", " >>  showTypeT type' >> c2s ')'
...
and showPointerType (e : AbsBasilIR.pointerType) : showable = match e with
       AbsBasilIR.PointerType1 (pointertype, openparen, type'0, type', closeparen) -> s2s "PointerType1" >> c2s ' ' >> c2s '(' >> showPOINTERTYPE pointertype  >> s2s ", " >>  showOpenParen openparen  >> s2s ", " >>  showTypeT type'0  >> s2s ", " >>  showTypeT type'  >> s2s ", " >>  showCloseParen closeparen >> c2s ')'
...
and showLocalVarParen (e : AbsBasilIR.localVarParen) : showable = match e with
       AbsBasilIR.LocalVarParenLocalVar localvar -> s2s "LocalVarParenLocalVar" >> c2s ' ' >> c2s '(' >> showLocalVar localvar >> c2s ')'
...
and showExpr (e : AbsBasilIR.expr) : showable = match e with
  ...
  |    AbsBasilIR.Expr_FSet (openparen, intval, expr0, expr, closeparen) -> s2s "Expr_FSet" >> c2s ' ' >> c2s '(' >> showOpenParen openparen  >> s2s ", " >>  showIntVal intval  >> s2s ", " >>  showExpr expr0  >> s2s ", " >>  showExpr expr  >> s2s ", " >>  showCloseParen closeparen >> c2s ')'
  |    AbsBasilIR.Expr_FAccess (openparen, intval, expr, closeparen) -> s2s "Expr_FAccess" >> c2s ' ' >> c2s '(' >> showOpenParen openparen  >> s2s ", " >>  showIntVal intval  >> s2s ", " >>  showExpr expr  >> s2s ", " >>  showCloseParen closeparen >> c2s ')'
