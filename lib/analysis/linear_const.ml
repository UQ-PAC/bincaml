...
[
    block %trans [
      (var v1:bv64=out1) := call @binary_expr();
...
[
  ...
  Hashtbl.iter
    (fun pid summary ->
      ...
      print_endline @@ LinearConstAnalysis.show_summary summary;
      print_endline
  ...
  {|
    @trans
    (L,L->Id), (L,out->⊤), (L,v1->\x . 0x0:bv64 * x + 0xffffffff:bv64), (L,v2->⊤)
    out, v1, v2
    @binary_expr
    (L,L->Id), (L,out1->\x . 0x0:bv64 * x + 0xffffffff:bv64), (L,v1->\x . 0x0:bv64 * x + 0xffffffff:bv64), (L,v2->⊤), (L,v3->⊤), (L,v4->\x . 0x0:bv64 * x + 0xffffffff:bv64)
    out1, v1, v2, v3, v4
    ID: ("@trans", 0)
    ...
    ID: ("@binary_expr", 1)
      { Var.V.name = "out1"; typ = bv64; scope = Var.LocalVar } -> 0xffffffff:bv64
      { Var.V.name = "v1"; typ = bv64; scope = Var.LocalVar } -> 0xffffffff:bv64
      { Var.V.name = "v2"; typ = bv8; scope = Var.LocalVar } -> ⊤
      { Var.V.name = "v3"; typ = bv8; scope = Var.LocalVar } -> ⊤
      { Var.V.name = "v4"; typ = bv64; scope = Var.LocalVar } -> 0xffffffff:bv64
    |}]
